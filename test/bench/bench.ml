...
let fn_bench benchs = 
  let fun_gettext t' textdomain translation = 
    match translation with
      | Plural(str_id,str_plural,_) ->
          ignore(GettextCompat.fdngettext t' textdomain (Obj.magic str_id) (Obj.magic str_plural) 0);
          ignore(GettextCompat.fdngettext t' textdomain (Obj.magic str_id) (Obj.magic str_plural) 1);
          ignore(GettextCompat.fdngettext t' textdomain (Obj.magic str_id) (Obj.magic str_plural) 2);
          ignore(GettextCompat.fdngettext t' textdomain (Obj.magic str_id) (Obj.magic str_plural) 3) 
      | _ ->
          ()
  in
